...
var ChangeNumberForGramToOunces = 0.03527396195;
var ChangeNumberForOuncesToGram = 28.34952;
var ConvertToOuncesBtn = document.getElementById("ConvertToOuncesBtn");
ConvertToOuncesBtn.addEventListener("click", GrammToOunces);
var ConvertToGramBtn = document.getElementById("ConvertToGramBtn");
ConvertToGramBtn.addEventListener("click", OuncesToGram);
function GrammToOunces() {
    var temp = Number(input.value) * ChangeNumberForGramToOunces;
    result.innerHTML = temp.toString() + " " + "ounces";
}
function OuncesToGram() {
    var temp = Number(input.value) * ChangeNumberForOuncesToGram;
